...
export const deleteRecipe = (id: number) =>
  deleteRequest({ path: `/recipe/${id}` });

export const updateRecipe = (id: number, payload: IFullRecipe) =>
  putRequest({ path: `/recipe/${id}`, payload });

export const addRecipeProducts = (id: number, payload: IProduct[]) =>
  postRequest({
    path: `/recipe/${id}/products`,
    payload,
  });

export const deleteRecipeProducts = (id: number, ids: number[]) =>
  postRequest({
